...
.form-field-wrapper-select::after {
  content: "";
  background: url(/images/655cf8f0c76a9d1a0e32f354_chevron-down-dropdown.svg) center;
  width: 24px;
  height: 24px;
    z-index: 1;
    grid-area: select;
...
.button-insights {
    ...
    border-radius: 4px;
    width: 55px;
    background: url(/images/654c211ec8ddfa925f8f3b84_button-insights.png) no-repeat center;
...
</svg></div></div></section><section nav-override="" className="v2_section z-7 background-color-white"><div className="padding-global padding-section-large-2"><div className="v2_container-large is-relative"><div data-w-id="8d22bb5f-5f5f-0ba2-bdfd-b66a9b568ab3" style={{"WebkitTransform":"translate3d(0, 0rem, 0) scale3d(1, 1, 1) rotateX(0) rotateY(0) rotateZ(0) skew(0, 0)","MozTransform":"translate3d(0, 0rem, 0) scale3d(1, 1, 1) rotateX(0) rotateY(0) rotateZ(0) skew(0, 0)","MsTransform":"translate3d(0, 0rem, 0) scale3d(1, 1, 1) rotateX(0) rotateY(0) rotateZ(0) skew(0, 0)","transform":"translate3d(0, 0rem, 0) scale3d(1, 1, 1) rotateX(0) rotateY(0) rotateZ(0) skew(0, 0)","opacity":"1"}} className="certified-practitioners"><h2 className="h2-large margin-0">This is a clinical team with real impact—driving science forward and delivering insights that matter to you</h2><div><p className="heading-sub-medium">The Docfolio Medical Group* includes more than 200 healthcare professionals including radiologists, MRI technologists, preventative health physicians, and nurse practitioners who support patients throughout the entire process.</p><div className="radiology-discaimer-text"><em>*Our exclusively-affiliated radiology group partners that are providing medical services to Docfolio.</em></div></div><a data-wf-native-id-path="8d22bb5f-5f5f-0ba2-bdfd-b66a9b568abb" data-wf-ao-click-engagement-tracking="true" data-wf-element-id="8d22bb5f-5f5f-0ba2-bdfd-b66a9b568abb" href="/medical-group" className="button is-light-green w-inline-block"><div>Our medical group</div></a></div><img className="comet-hp-1" src="/images/69970f35b608a80cbffd3a34_comet.webp" width="2490" height="2490" alt="" style={{"opacity":"1"}} sizes="(max-width: 2490px) 100vw, 2490px" data-w-id="8d22bb5f-5f5f-0ba2-bdfd-b66a9b568abe" loading="lazy" srcSet="/images/69970f35b608a80cbffd3a34_comet-p-500.png 500w, /images/69970f35b608a80cbffd3a34_comet-p-800.png 800w, /images/69970f35b608a80cbffd3a34_comet-p-1080.png 1080w, /images/69970f35b608a80cbffd3a34_comet-p-1600.webp 1600w, /images/69970f35b608a80cbffd3a34_comet-p-2000.png 2000w, /images/69970f35b608a80cbffd3a34_comet.webp 2490w"/><div className="spacer-xhuge"></div><div className="v2_team"><div className="team-row is-team"><div className="team-row-inner is-team"><div className="v2_team-row"><div className="v2_team-image-inverse"><img width="609" height="786" alt="" src="/images/team/doctor-1.jpg" loading="lazy" srcSet="/images/69f02b724875132c9356002e_Dr._Karolina-p-500.jpg 500w, /images/69f02b724875132c9356002e_Dr._Karolina-p-800.jpg 800w, /images/team/doctor-1.jpg 900w" sizes="(max-width: 767px) 100vw, 609px" className="img-cover"/></div><div className="v2_team-image"><img width="606" height="786" alt="" src="/images/team/doctor-2.jpg" loading="lazy" className="img-cover"/></div><div className="v2_team-image-inverse"><img width="606" height="786" alt="" src="/images/team/doctor-3.jpg" loading="lazy" className="img-cover"/></div><div className="v2_team-image"><img width="609" height="786" alt="" src="/images/team/doctor-4.jpg" loading="lazy" className="img-cover"/></div><div className="v2_team-image-inverse"><img width="609" height="786" alt="" src="/images/team/doctor-5.jpeg" loading="lazy" srcSet="/images/img_8021_500.jpeg 500w, /images/img_8021_800.jpeg 800w, /images/img_8021_1080.jpeg 1080w, /images/img_8021_1600.jpeg 1600w, /images/img_8021_2000.jpeg 2000w, /images/team/doctor-5.jpeg 2250w" sizes="(max-width: 767px) 100vw, 609px" className="img-cover"/></div><div className="v2_team-image"><img width="606" height="786" alt="" src="/images/team/doctor-6.jpg" loading="lazy" className="img-cover"/></div><div className="v2_team-image-inverse"><img width="609" height="786" alt="" src="/images/team/doctor-7.jpg" loading="lazy" className="img-cover"/></div></div></div></div></div><div data-w-id="8d22bb5f-5f5f-0ba2-bdfd-b66a9b568adb" style={{"WebkitTransform":"translate3d(0, 0rem, 0) scale3d(1, 1, 1) rotateX(0) rotateY(0) rotateZ(0) skew(0, 0)","MozTransform":"translate3d(0, 0rem, 0) scale3d(1, 1, 1) rotateX(0) rotateY(0) rotateZ(0) skew(0, 0)","MsTransform":"translate3d(0, 0rem, 0) scale3d(1, 1, 1) rotateX(0) rotateY(0) rotateZ(0) skew(0, 0)","transform":"translate3d(0, 0rem, 0) scale3d(1, 1, 1) rotateX(0) rotateY(0) rotateZ(0) skew(0, 0)","opacity":"1"}} className="research-logos-wrap"><div className="lp-team_research-list-wrapper w-dyn-list"><div role="list" className="lp-team_research-list is-flex w-dyn-items"><div role="listitem" className="lp-team_research-list-items w-dyn-item"><img src="/images/68806d248958e707e5db619d_home-logo-1.webp" loading="lazy" alt="Mount Sinai - Research partner logo" className="research-logo"/></div><div role="listitem" className="lp-team_research-list-items w-dyn-item"><img src="/images/68806d4248003e3904dcf2d6_home-logo-2.webp" loading="lazy" alt="UCLA Health - Research partner logo" className="research-logo"/></div><div role="listitem" className="lp-team_research-list-items w-dyn-item"><img src="/images/68806e1baa7ee6ad5206e190_home-logo-4.webp" loading="lazy" alt="Johns Hopkins - Research partner logo" className="research-logo"/></div><div role="listitem" className="lp-team_research-list-items w-dyn-item"><img src="/images/68806f5249991d1ce9b0ae35_home-logo-10.webp" loading="lazy" alt="Sutter Health - Research partner logo" className="research-logo"/></div><div role="listitem" className="lp-team_research-list-items w-dyn-item"><img src="/images/68806e4406e1e7e5723b52a0_home-logo-5.webp" loading="lazy" alt="Penn University - Research partner logo" className="research-logo"/></div><div role="listitem" className="lp-team_research-list-items w-dyn-item"><img src="/images/68806e6a52fe2366e491eb3f_home-logo-6.webp" loading="lazy" alt="Brown  - Research partner logo" className="research-logo"/></div><div role="listitem" className="lp-team_research-list-items w-dyn-item"><img src="/images/68806eacb53378b1a16ca4d4_home-logo-7.webp" loading="lazy" alt="Baptist Health  - Research partner logo" className="research-logo"/></div><div role="listitem" className="lp-team_research-list-items w-dyn-item"><img src="/images/68806f010677d63585a1ed57_home-logo-9.webp" loading="lazy" alt="Stanford University  - Research partner logo" className="research-logo"/></div></div></div></div></div><div className="spacer-xlarge"></div></div></section><section nav-override="" className="v2_section background-color-white"><div className="spacer-large"></div><div><div className="logos-wrapper"><div className="v2_logos-holder"><div className="logos_row is-opacity-50"><div className="logo_wrapper"><img src="/images/696f5ce335e915312dd1bc70_cnbc.svg" loading="lazy" width="75" height="54" alt="Featured on CNBC" className="carousel-logo is-cnbc"/></div><div className="logo_wrapper"><img src="/images/696f5ce33c298266d96704ca_bbc.svg" loading="lazy" width="74" height="21" alt="Featured on BBC" className="carousel-logo is-bbc"/></div><div className="logo_wrapper"><img src="/images/696f5ce3448255d3774d1e72_bloomberg.svg" loading="lazy" width="141" height="27" alt="Featured on Bloomberg" className="carousel-logo is-bloomberg"/></div><div className="logo_wrapper"><img src="/images/696f5ce3b5579f8d9a4021e2_buzzfeed.svg" loading="lazy" width="141" height="24" alt="Featured on Buzzfeed" className="carousel-logo is-buzzfeed"/></div><div className="logo_wrapper"><img src="/images/696f5ce3d72ee5517beaf3db_womens_health.svg" loading="lazy" alt="" className="carousel-logo is-womenshealth"/></div><div className="logo_wrapper"><img src="/images/696f5ce39339c1d88b6d33b9_mens_health.svg" loading="lazy" alt="" className="carousel-logo is-menshealth"/></div><div className="logo_wrapper"><img src="/images/696f5ce3569aad5821d79eee_fast_company.svg" loading="lazy" alt="" className="carousel-logo is-fastcompany"/></div><div className="logo_wrapper"><img src="/images/696f5ce3603cb9b8bf9db409_forbes.svg" loading="lazy" alt="" className="carousel-logo is-forbes"/></div><div className="logo_wrapper"><img src="/images/696f5cde8630c2f272bc6791_glamour.svg" loading="lazy" alt="" className="carousel-logo is-glamour"/></div><div className="logo_wrapper"><img src="/images/696f5cdd74bde14f6fcbb6ce_new_yorker.svg" loading="lazy" alt="Featured in New Yorker" className="carousel-logo is-newyorker"/></div><div className="logo_wrapper"><img src="/images/696f5cde925c1619219bd440_loas_angeles_times.svg" loading="lazy" alt="" className="carousel-logo is-latimes"/></div><div className="logo_wrapper"><img src="/images/696f5cde905de39418b8fe28_town___country.svg" loading="lazy" alt="" className="carousel-logo is-tanc"/></div><div className="logo_wrapper"><img src="/images/696f5cdfbddcc2ea57097716_air_mail_logo.png.png" loading="lazy" alt="" className="carousel-logo is-airmail"/></div><div className="logo_wrapper"><img src="/images/696f5cde6fcc7c6c6ebf60f9_tech_crunch.svg" loading="lazy" alt="" className="carousel-logo is-tc"/></div><div className="logo_wrapper"><img src="/images/696f5cddddfc47569f1480ae_poosh.svg" loading="lazy" alt="" className="carousel-logo is-poosh"/></div><div className="logo_wrapper"><img src="/images/696f5cdde231f45c8740900c_business_insider.svg" loading="lazy" alt="" className="carousel-logo is-businessinsider"/></div><div className="logo_wrapper"><img src="/images/696f5cddc737ab9c0b30bd7b_fox.svg" loading="lazy" alt="" className="carousel-logo is-fox"/></div><div className="logo_wrapper"><img src="/images/696f5cdd41937d2a734ba895_gq.svg" loading="lazy" alt="" className="carousel-logo is-gq"/></div><div className="logo_wrapper"><img src="/images/696f5cdd5d7e878774fac248_fortune.svg" loading="lazy" alt="" className="carousel-logo is-fortune"/></div><div className="logo_wrapper"><img src="/images/696f5cddc5365da937c27caf_cnet.svg" loading="lazy" alt="" className="carousel-logo is-cnet"/></div><div className="logo_wrapper"><img src="/images/696f5d38b30dcbe589cc032b_huffpost.svg" loading="lazy" alt="" className="carousel-logo is-huffpost"/></div><div className="logo_wrapper"><img src="/images/696f5cded3686d0851fb65ae_motherly_logo.png.png" loading="lazy" sizes="100vw" srcSet="/images/696f5cded3686d0851fb65ae_motherly_logo.png-p-500.png 500w, /images/696f5cded3686d0851fb65ae_motherly_logo.png-p-800.png 800w, /images/696f5cded3686d0851fb65ae_motherly_logo.png.png 851w" alt="" className="carousel-logo is-motherly"/></div></div><div className="logos_row is-opacity-50"><div className="logo_wrapper"><img src="/images/696f5ce335e915312dd1bc70_cnbc.svg" loading="lazy" width="75" height="54" alt="" className="carousel-logo is-cnbc"/></div><div className="logo_wrapper"><img src="/images/696f5ce33c298266d96704ca_bbc.svg" loading="lazy" width="74" height="21" alt="" className="carousel-logo is-bbc"/></div><div className="logo_wrapper"><img src="/images/696f5ce3448255d3774d1e72_bloomberg.svg" loading="lazy" width="141" height="27" alt="" className="carousel-logo is-bloomberg"/></div><div className="logo_wrapper"><img src="/images/696f5ce3b5579f8d9a4021e2_buzzfeed.svg" loading="lazy" width="141" height="24" alt="" className="carousel-logo is-buzzfeed"/></div><div className="logo_wrapper"><img src="/images/696f5ce3d72ee5517beaf3db_womens_health.svg" loading="lazy" alt="" className="carousel-logo is-womenshealth"/></div><div className="logo_wrapper"><img src="/images/696f5ce39339c1d88b6d33b9_mens_health.svg" loading="lazy" alt="" className="carousel-logo is-menshealth"/></div><div className="logo_wrapper"><img src="/images/696f5ce3569aad5821d79eee_fast_company.svg" loading="lazy" alt="" className="carousel-logo is-fastcompany"/></div><div className="logo_wrapper"><img src="/images/696f5ce3603cb9b8bf9db409_forbes.svg" loading="lazy" alt="" className="carousel-logo is-forbes"/></div><div className="logo_wrapper"><img src="/images/696f5cde8630c2f272bc6791_glamour.svg" loading="lazy" alt="" className="carousel-logo is-glamour"/></div><div className="logo_wrapper"><img src="/images/696f5cdd74bde14f6fcbb6ce_new_yorker.svg" loading="lazy" alt="" className="carousel-logo is-newyorker"/></div><div className="logo_wrapper"><img src="/images/696f5cde925c1619219bd440_loas_angeles_times.svg" loading="lazy" alt="" className="carousel-logo is-latimes"/></div><div className="logo_wrapper"><img src="/images/696f5cde87b260933f105e59_washington_post.svg" loading="lazy" alt="" className="carousel-logo is-washpost"/></div><div className="logo_wrapper"><img src="/images/696f5cde905de39418b8fe28_town___country.svg" loading="lazy" alt="" className="carousel-logo is-tanc"/></div><div className="logo_wrapper"><img src="/images/696f5cdfbddcc2ea57097716_air_mail_logo.png.png" loading="lazy" alt="" className="carousel-logo is-airmail"/></div><div className="logo_wrapper"><img src="/images/696f5cde6fcc7c6c6ebf60f9_tech_crunch.svg" loading="lazy" alt="" className="carousel-logo is-tc"/></div><div className="logo_wrapper"><img src="/images/696f5cddddfc47569f1480ae_poosh.svg" loading="lazy" alt="" className="carousel-logo is-poosh"/></div><div className="logo_wrapper"><img src="/images/696f5cdde231f45c8740900c_business_insider.svg" loading="lazy" alt="" className="carousel-logo is-businessinsider"/></div><div className="logo_wrapper"><img src="/images/696f5cddc737ab9c0b30bd7b_fox.svg" loading="lazy" alt="" className="carousel-logo is-fox"/></div><div className="logo_wrapper"><img src="/images/696f5cdd41937d2a734ba895_gq.svg" loading="lazy" alt="" className="carousel-logo is-gq"/></div><div className="logo_wrapper"><img src="/images/696f5cdd5d7e878774fac248_fortune.svg" loading="lazy" alt="" className="carousel-logo is-fortune"/></div><div className="logo_wrapper"><img src="/images/696f5cddc5365da937c27caf_cnet.svg" loading="lazy" alt="" className="carousel-logo is-cnet"/></div><div className="logo_wrapper"><img src="/images/696f5d38b30dcbe589cc032b_huffpost.svg" loading="lazy" alt="" className="carousel-logo is-huffpost"/></div><div className="logo_wrapper"><img src="/images/696f5cded3686d0851fb65ae_motherly_logo.png.png" loading="lazy" sizes="100vw" srcSet="/images/696f5cded3686d0851fb65ae_motherly_logo.png-p-500.png 500w, /images/696f5cded3686d0851fb65ae_motherly_logo.png-p-800.png 800w, /images/696f5cded3686d0851fb65ae_motherly_logo.png.png 851w" alt="" className="carousel-logo is-motherly"/></div></div><div className="carousel-code w-embed"><style dangerouslySetInnerHTML={{ __html: `
/* Original animation */
.logos_row {
